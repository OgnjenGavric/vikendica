  ...
  return (
    <section className='max-container padding-container flex flex-col gap-20 py-10 pb-10 md:gap-28 lg:py-20 xl:flex-row'>
      ...
      <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
        <h1 className='bold-40 lg:bold-88 text-green-70'>
          Vikendica <em className=' text-green-30'>"M&L"</em> na Sani, Prijedor
        </h1>

        <p className='regular-20 mt-6 text-green-70 xl:max-w-[650px]'>
          Vikendica "M&L" nudi idiličan odmor na obali rijeke Sane u Gaćanima,
          nedaleko od Prijedora. Savršena je za opuštanje u prirodi i uživanje u
          miru i tišini. Vikendica je opremljena za boravak do 4 osobe i nudi
          sve što vam je potrebno za udoban boravak.
        </p>
        ...
        <div className='flex flex-col w-full gap-3'>
          ...
          <Link href='viber://chat/?number=%2B38765688948'>
            <Button
              type='button'
              title='VIBER'
              icon='/viber.svg'
      ...
      <div className='relative flex flex-col items-center gap-7 justify-center'>
        ...
        <Link
          href='https://maps.app.goo.gl/pCWgJxXjiodRRmWn9'
          target='_blank'
          className='relative z-20 flex w-[268px] flex-col gap-8 rounded-3xl px-7 py-8 bg-green-950'
        >
